import rclpy
import DR_init
from myutils.drl_function import generate_3x3_pattern, grip, ungrip
# for single robot
ROBOT_ID = "dsr01"
ROBOT_MODEL = "m0609"
VELOCITY, ACC = 30, 30
...
def main(args=None):
    ...
    pos8 = posx([499.2635192871094, -103.83866119384766, 25.03506088256836, 9.55066967010498, -179.9114227294922, 8.23847484588623])
    ...
    def point_to_point(position1,position2):
        ...
        movel(position2,vel=VELOCITY,acc=ACC)
        wait(0.3)
        ungrip()
        wait(0.3)
        movel(pos2_zup,vel=VELOCITY,acc=ACC)
    ...
    while rclpy.ok():
        ...
        # 초기 위치로 이동
        for i in range(9):
            init_pos = generate_3x3_pattern(pal1,i)
            de_pos = generate_3x3_pattern(pal2,i)
